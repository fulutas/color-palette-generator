...
// Import color-scheme-js library
...
function notification(msg) {
  ...
  div.className = "alert";
  div.innerHTML = msg;
  div.firstElementChild.style.color = div.firstElementChild.innerText
...
function generateColorPalette() {
  ...
  for (let i = 1; i <= 5; i++) {
    ...
    li.addEventListener("click", (e) => {
      let targetInput = e.target.parentNode.querySelector('input[name="color"]'); // ul içinde arama yapar
      targetInput.select();
